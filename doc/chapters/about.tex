...
The document is organised into two parts. \textbf{Part~I (Foundations)} is for the
reader who arrives strong in one of this book's two parent disciplines but new to
the other. Because the monograph fuses statistics with downstream separation
...
\code{downstream\_doe.foundations}---not schematics.\par}
